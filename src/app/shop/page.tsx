  ...
  return (
    <>
      ...
      <Section className='bg-background text-foreground py-12 md:py-16'>
        <Container>
          <PageTitle level='h1' className='text-center mb-8'>Shop All Products</PageTitle>
          ...
          <div className='mt-8 flex justify-center gap-4'>
            ...
            <Button variant='outline' size='sm'>Women</Button>
      ...
      <Section className='bg-muted text-foreground'>
        <Container>
          <motion.div variants={stagger} initial='initial' animate='animate' className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
